...
describe("App", () => {
  ...
  it("progresses to the second question after selecting an answer for the first question", () => {
  ...
  it("progresses to the third question after selecting an answer for the second question", () => {
    const { getByText, queryByText } = render(<App />);
    ...
    // Verify that the previous question and options are no longer visible
    const secondQuestion = queryByText(
  ...
  it("progresses to the fourth question after selecting an answer for the third question", () => {
    const { getByText, queryByText } = render(<App />);
  ...
  it("progresses to the fifth question after selecting an answer for the fourth question", () => {
    const { getByText, queryByText } = render(<App />);
  ...
  describe("For first Question",()=>{
    it("When user chooses the option correctly", () => {
      const { getByText, queryByText } = render(<App />);
    ...
    it("For first Question, When user chooses the option Incorrectly", () => {
      const { getByText, queryByText } = render(<App />);
  ...
  describe("For Second Question",()=>{
    ...
    it("For Second Question, When user chooses the option Incorrectly", () => {
      const { getByText, queryByText } = render(<App />);
  ...
  describe("For Third Question",()=>{
    ...
    it("For Third Question When user chooses the option Incorrectly", () => {
      const { getByText, queryByText } = render(<App />);
  ...
  describe("For Fourth Question",()=>{
    ...
    it("For Fourth Question, When user chooses the option Incorrectly", () => {
      const { getByText, queryByText } = render(<App />);
  ...
  describe("For Fifth Question",()=>{
    ...
    it("For Fifth Question, When user chooses the option Incorrectly", () => {
      const { getByText, queryByText } = render(<App />);
